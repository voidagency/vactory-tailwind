...
// https://tailwindui.com/components/marketing/sections/feature-sections#component-12712a7925f8fd86e4f8331cf686d092
	...
	return (
		<div className="py-16 bg-gray-50 overflow-hidden lg:py-24">
			<div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
				<svg
					className="hidden lg:block absolute ltr:left-full rtl:right-full transform ltr:-translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/4"
					width="404"
					height="784"
					fill="none"
					viewBox="0 0 404 784"
				...
				<div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
					...
					>
						<svg
							className="absolute ltr:left-1/2 rtl:right-1/2 transform ltr:-translate-x-1/2 rtl:translate-x-1/2 translate-y-16 lg:hidden"
							width="784"
							height="404"
							fill="none"
							viewBox="0 0 784 404"
				...
				<svg
					className="hidden lg:block absolute ltr:right-full rtl:left-full transform ltr:translate-x-1/2 rtl:-translate-x-1/2 translate-y-12"
					width="404"
					height="784"
					fill="none"
					viewBox="0 0 404 784"
