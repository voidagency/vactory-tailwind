	...
	return (
		<div className="relative bg-white">
			<div className="max-w-7xl mx-auto px-4 sm:px-6">
				<div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10 md:rtl:space-x-reverse">
						...
						<div className="relative">
							...
							>
								<div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
									...
									<div className="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:ltr:space-x-reverse sm:px-8">
										...
										<div className="flow-root">
											...
											>
												...
												<span className="rtl:ml-3 ltr:mr-3">
													Contact Sales
												</span>
											</a>
										</div>
						...
						<div className="mt-6">
							<nav className="grid gap-y-8">
								...
								>
									...
									<span className="ltr:ml-3 rtl:mr-3 text-base font-medium text-gray-900">
										Analytics
									</span>
								</a>
