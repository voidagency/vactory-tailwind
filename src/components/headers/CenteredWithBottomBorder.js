	...
	return (
		<div class="relative bg-white">
			<div class="max-w-7xl mx-auto px-4 sm:px-6">
				<div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10 md:rtl:space-x-reverse">
					...
					<div class="ltr:-mr-2 rtl:-ml-2 -my-2 md:hidden">
						<button
							onClick={() => {
								SetMenuOpen(true);
							}}
					...
					<nav class="hidden md:flex space-x-10 rtl:space-x-reverse">
						<div class="relative">
							...
							>
								<div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
									...
									<div class="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:ltr:space-x-reverse sm:px-8">
										<div class="flow-root">
											<a
												href="#!"
						...
						<div class="relative">
							...
							>
								<span>More</span>
								{/* <!-- 
								Heroicon name: chevron-down Item active:
						...
						<div class="mt-6">
							<nav class="grid gap-y-8">
								...
								>
									...
									<span class="ltr:ml-3 rtl:mr-3 text-base font-medium text-gray-900">
										Analytics
									</span>
								</a>
